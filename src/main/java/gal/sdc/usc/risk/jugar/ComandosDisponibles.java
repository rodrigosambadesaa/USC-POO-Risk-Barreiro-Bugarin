...
public final class ComandosDisponibles {
  ...
  public void iniciarPartida(gal.sdc.usc.risk.domain.Jugador jugador) {
  ...
  public void iniciarTurno(gal.sdc.usc.risk.domain.Jugador jugador) {
    this.acabarTurno();
