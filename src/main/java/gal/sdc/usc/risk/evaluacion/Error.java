...
public class Error {
  //
  public static final String MORE_ANSWERS = "Existen más respuestas de las requeridas";
  public static final String MISSING_ANSWER =
      "Alguna de las respuestas no es correcta o no se encuentra";
  //
  ...
  public String toString() {
    ...
    return (cc
        ...
        + this.description
        + "\n"
        + ((this.missingGold != null)
            ? (cc + "Respuesta requerida:\n" + this.missingGold.toString())
            : ""));
  }
}
