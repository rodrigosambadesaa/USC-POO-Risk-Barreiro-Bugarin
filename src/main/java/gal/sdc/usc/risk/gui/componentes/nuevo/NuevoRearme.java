...
public class NuevoRearme extends Partida {
  ...
  private void generar() {
    Dialogo dialogo = new Dialogo().setHeading("Rearmar Paises").setCloseText("Cancelar");
    ...
    ejecutar.setOnAction(
        event -> {
          ...
          Ejecutor.comando(
              "rearmar "
                  + pais1.getAbreviatura()
                  + " "
                  + numEjercitos.getText()
                  + " "
                  + pais2.getAbreviatura(),
              new EjecutorListener() {
                ...
                public void onComandoEjecutado() {
                  ...
                  PrincipalController.mensaje(
                      "Se han asignado " + finalEjercitos + " a " + pais2.getNombre());
                }
              });
        });
