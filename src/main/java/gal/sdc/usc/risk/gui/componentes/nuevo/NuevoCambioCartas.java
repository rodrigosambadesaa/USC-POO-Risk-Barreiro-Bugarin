...
public class NuevoCambioCartas extends Partida {
  ...
  private void generar() {
    Dialogo dialogo =
        new Dialogo().setHeading("Cambiar Cartas a Ejércitos").setCloseText("Cancelar");
    ...
    comboCarta2
        .disableProperty()
        .bind(comboCarta1.getSelectionModel().selectedItemProperty().isNull());
        ...
        .addListener(
            (o, oldValue, newValue) -> {
              if (newValue == null) {
                ...
                int ejercitos =
                    CambiarCartas.calcularCambiosString(
                        cartasCambio, super.getJugadorTurno(), super.getMapa());
    ...
    ejecutar
        .disableProperty()
        .bind(comboCarta3.getSelectionModel().selectedItemProperty().isNull());
              ...
              new EjecutorListener() {
                ...
                public void onComandoEjecutado() {
                  ...
                  PrincipalController.mensaje(
                      "Se han cambiado las cartas, ya puedes repartir los ejércitos");
                }
              });
        });
